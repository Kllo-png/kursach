...
label2.caption:='Данный тест на 15 вопросов рассчитан на 5 минут.'+#13#10'Результат считается удовлетворительным если как минимум ответы на 10 из 15 вопросов правильные'+#13#10+'Таймер запустится после ответа на первый вопрос';
...
label3.Caption := 'Правильных ответов: '+inttostr(ball)+#13#10+'Процент правильных ответов:'+floattostr(ball/15*100)+'%';
